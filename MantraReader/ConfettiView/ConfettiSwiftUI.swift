        ...
        .onChange(of: counter) { value in
            if firstAppear {
                for i in 0...confettiConfig.repetitions {
                    afterDelay(confettiConfig.repetitionInterval * Double(i)) {
...
struct ConfettiContainer: View {
    ...
    var body: some View{
        ...
        .onAppear {
            if firstAppear {
                afterDelay(confettiConfig.animationDuration) {
    ...
    var body: some View{
        ConfettiAnimationView(
            ...
            .onAppear {
                ...
                afterDelay(getDelayBeforeRainAnimation()) {
                    withAnimation(.timingCurve(0.12, 0, 0.39, 0, duration: confettiConfig.rainAnimationDuration)) {
